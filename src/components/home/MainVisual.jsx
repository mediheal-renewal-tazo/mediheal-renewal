    ...
    return (
        <div className="main">
            <div className="main__inner">
                <div className="main__visual__text">
                    <h2 className="main__visual__text left">
                        <span>when disign meets</span>
                        <span>production,</span>
                    </h2>
                    <div className="main__visual__line"></div>
                    <h2 className="main__visual__text right">
                        <span>perfect</span>
                        <span>packaging is born</span>
                    </h2>
                </div>
                <div className="main__visual__dsc">
